...
public class RingdroidSelectActivity extends ListActivity
        ...
        mAdapter.setViewBinder(new SimpleCursorAdapter.ViewBinder() {
            public boolean setViewValue(View view, Cursor cursor, int columnIndex) {
                ...
                if (view.getId() == R.id.row_title) {
                    TextView tvTitle =  ((TextView) view);//.setSelected(true);
                    tvTitle.setSelected(true);
                    tvTitle.setTypeface(Typeface.createFromAsset(RingdroidSelectActivity.this.getAssets(), "Baloo-Regular.ttf"));

                }

                if (view.getId() == R.id.row_artist) {
                    TextView tvArtist =  ((TextView) view);
                    tvArtist.setTypeface(Typeface.createFromAsset(RingdroidSelectActivity.this.getAssets(), "Baloo-Regular.ttf"));

                }

                if (view.getId() == R.id.row_album) {
                    TextView tvAlbum =  ((TextView) view);
                    tvAlbum.setTypeface(Typeface.createFromAsset(RingdroidSelectActivity.this.getAssets(), "Baloo-Regular.ttf"));
    ...
    private void setSoundIconFromCursor(ImageView view, Cursor cursor) {
        if (0 != cursor.getInt(cursor.getColumnIndexOrThrow(
            ...
            view.setImageResource(R.drawable.ic_music_note_black_36dp);
            ...
            view.setImageResource(R.drawable.ic_alarm_black_36dp);
            /*((View) view.getParent()).setBackgroundColor(
                    getResources().getColor(R.color.type_bkgnd_alarm));*/
        } else if (0 != cursor.getInt(cursor.getColumnIndexOrThrow(
                MediaStore.Audio.Media.IS_NOTIFICATION))) {
            view.setImageResource(R.drawable.ic_notifications_none_black_36dp);
         /*   ((View) view.getParent()).setBackgroundColor(
                    getResources().getColor(R.color.type_bkgnd_notification));*/
        } else if (0 != cursor.getInt(cursor.getColumnIndexOrThrow(
                MediaStore.Audio.Media.IS_MUSIC))) {
            view.setImageResource(R.drawable.ic_library_music_black_36dp);
          /*  ((View) view.getParent()).setBackgroundColor(
